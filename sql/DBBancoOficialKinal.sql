...
INSERT INTO Empleados (nombreEmpleado, apellidoEmpleado, usuario, contrasena, cargo, salario, oficina, estado, codigoCargoEmpleado,imagenUser) VALUES ('Ana', 'Martínez', 'amartinez', 'password1', 'Gerente General', 5000.00, '101', '0', 1,LOAD_FILE('C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/cuevon.png'));
INSERT INTO Empleados (nombreEmpleado, apellidoEmpleado, usuario, contrasena, cargo, salario, oficina, estado, codigoCargoEmpleado,imagenUser) VALUES ('Luis', 'Gómez', 'lgomez', 'password2', 'Analista Financiero', 3000.00, '202', '1', 2,LOAD_FILE('C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/cuevon.png'));
INSERT INTO Empleados (nombreEmpleado, apellidoEmpleado, usuario, contrasena, cargo, salario, oficina, estado, codigoCargoEmpleado,imagenUser) VALUES ('Marta', 'Rodríguez', 'neryd', '1234', 'Asistente Administrativo', 1500.00, '303', '1', 3,LOAD_FILE('C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/cuevon.png'));
